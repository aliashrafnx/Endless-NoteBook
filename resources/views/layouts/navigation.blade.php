<nav x-data="{ open: false }" class="bg-white bg-opacity-90 backdrop-blur-md border-b border-gray-200 shadow-md">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                                <img src="{{ asset('images/icons8-love-book-48.png') }}" 
             alt="Logo" 
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('logout')"
                            onclick="event.preventDefault(); this.closest('form').submit();" class="text-black-800">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
                </form>
            </div>
